      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0 mt-19">
        ...
        </div>
        {
          Array.from({ length: 10 }, (_, i) => (
            <div key={i} className="aspect-video rounded-xl bg-muted/50 flex items-center justify-center">
              <span className="text-muted-foreground">Additional Content {i + 1}</span>
            </div>
          ))}
      </div>
    </SidebarInset>
