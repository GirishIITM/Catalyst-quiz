...
import { smartclasshub } from "@/assets";
...
export function Header() {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 bg-black dark:bg-gray-900 text-white p-4 z-[1000]">
        <div className="flex items-center justify-between px-8">
          <div className="w-auto">
            <img src={smartclasshub} alt="SmartClassHub" className="h-10 w-auto" />
          </div>
